import { Choice } from "./FlatListChooser";
...
export function ChooseActivityScreen() {
  ...
  choices.push(
    getActivityChoice("AGAINST_COMPUTER", { activityType: "AGAINST_COMPUTER" })
  );
  choices.push(
    getActivityChoice("PASS_AND_PLAY", { activityType: "PASS_AND_PLAY" })
  );
  ...
  return (
    <View style={styles.container}>
      <ImageBackground
        ...
        source={require("./activityBackImage.png")}
      >
        <TitleBar />
        <FlatList
